                                ...
                                if (response.body() != null) {
                                    ...
                                    if (response.body().getStatus() != null && response.body().getStatus().equals("success")) {
                                        ...
                                        if (autoAssignModel != null) {
                                            ...
                                            MyPreferences.saveInt(FindingShopprActivity.this, ConstantValue.KEY_CHAT_ID,chat_id);
                                            MyPreferences.saveBoolean(FindingShopprActivity.this, ConstantValue.KEY_IS_CHAT_PROGRESS,true);
                                            finish();
                                        } else {
                                            Toast.makeText(FindingShopprActivity.this, "" + autoAssignModel.getMessage(), Toast.LENGTH_SHORT).show();
                                        }
